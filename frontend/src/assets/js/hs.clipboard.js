...
HSCore.components.HSClipboard = {
  ...
  setShortcodes(el, params) {
    ...
    if ($element.tagName === 'SELECT' || $element.tagName === 'INPUT' || $element.tagName === 'TEXTAREA') {
      ...
      settings.shortcodes[settings.contentTarget] = $element.innerText
    }
  },
      ...
      this.collection.push({
        ...
        options: Object.assign({}, options, {
          ...
          text: (button) => {
            ...
            return options.shortcodes[dataSettings.contentTarget] || item.getAttribute('data-clipboard-text');
          }
        })
      })
  },
